...
var https	= require("https"); // https functionality
...
app.use("/distar", express.static(path.resolve(__dirname, "../..", "ar_social_distancing/application_web")));
app.use(cors()); 
...
const webServer = https.createServer({
  key:  fs.readFileSync("/etc/letsencrypt/live/5gwebxr.com/privkey.pem"),
  ca:   fs.readFileSync("/etc/letsencrypt/live/5gwebxr.com/chain.pem"),
  cert: fs.readFileSync("/etc/letsencrypt/live/5gwebxr.com/fullchain.pem")	
